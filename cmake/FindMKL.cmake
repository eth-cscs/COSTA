                ...
                foreach(_mpi_impl "MPICH" "OMPI")
                    ...
                    if(_mkl_scalapack_lib
                       ...
                       AND NOT TARGET ${_scalapack_tgt})
                        ...
                        message("adding library: ${_scalapack_tgt}")
                        set_target_properties(${_scalapack_tgt} PROPERTIES
                            INTERFACE_LINK_LIBRARIES "${_scalapack_libs}")
                    else()
                        message("NOT adding library: ${_scalapack_tgt}")
                        if (NOT _mkl_scalapack_lib)
                            message("    mkl_scalapack_lib false")
                        endif()
                        if (NOT TARGET ${_blacs_tgt})
                            message("    _blacs_tgt not target")
                        endif()
                        if (NOT TARGET ${_scalapack_tgt})
                            message("    _scalapack_tgt not target")
                        endif()
                    endif()
                endforeach()
            endforeach()
